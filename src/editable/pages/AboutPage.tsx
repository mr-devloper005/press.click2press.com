  ...
  return (
    <EditableSiteShell>
      <main className="bg-[#e9e9e9] text-[#111]">
        <section className="border-b border-black bg-[var(--slot4-accent-fill)] text-white">
        ...
        <section className="mx-auto grid max-w-[var(--editable-container)] border-x border-black bg-white lg:grid-cols-[1.45fr_0.55fr]">
          ...
          <aside className="grid bg-[#e9e9e9]">
        ...
        <section className="border-y border-black bg-[#606160] text-white">
          <div className="mx-auto flex max-w-[var(--editable-container)] flex-col gap-6 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            ...
            <Link href="/search" className="inline-flex w-fit bg-[var(--slot4-accent-fill)] px-6 py-4 text-xs font-black uppercase tracking-[0.18em]">Explore the archive</Link>
          </div>
        </section>
      </main>
    </EditableSiteShell>
